...
_HELP: dict[str, str] = {
    ...
    "groq_api_key": "Groq key — generous free tier (llama-3.3-70b).",
    ...
    "freellmapi_api_key": "Self-hosted FreeLLMAPI key (http://localhost:3001).",
    "freellmapi_base_url": "FreeLLMAPI endpoint.",

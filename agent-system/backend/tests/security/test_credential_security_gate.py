...
2. Secret never appears in logs, traces, task descriptions, telemetry, or Telegram history.
...
8. Complete E2E flow: Telegram setup -> CredentialStore -> SSH/tool -> zero leakage.
"""
